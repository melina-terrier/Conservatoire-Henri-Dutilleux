<?php
/**
 * Motif décoratif SVG animé en parallaxe.
 *
 * Utilisé sur la front page (template-parts/hero.php) et sur les fiches
 * d'événements (single-agenda.php). Les `<path>` sont animés au scroll via
 * Rellax (data-rellax-speed) et au chargement via GSAP (cf. src/js/script.js,
 * section "ANIMATION DES MOTIFS").
 *
 * Args attendus :
 *  - wrapper_class : classe CSS du conteneur (ex: 'hero__patterns', 'single__patterns')
 *
 * Si `wrapper_class` n'est pas fourni, fallback sur 'pattern' (neutre).
 */
$wrapper_class = isset( $args['wrapper_class'] ) ? $args['wrapper_class'] : 'pattern';
?>
<div class="<?php echo esc_attr( $wrapper_class ); ?> rellax" data-rellax-speed="-5">
  <svg viewBox="0 0 1260 700" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
    <g class="curveLines">
